import { parser as B } from "../../../@lezer/javascript/dist/index.mjs";
import { LanguageSupport as F, LRLanguage as j, sublanguageProp as T, defineLanguageFacet as x, indentNodeProp as L, foldNodeProp as N, continuedIndent as S, delimitedIndent as P, flatIndent as O, foldInside as V, syntaxTree as C } from "../../language/dist/index.mjs";
import { EditorSelection as M } from "../../state/dist/index.mjs";
import { EditorView as _ } from "../../view/dist/index.mjs";
import { snippetCompletion as r, ifNotIn as R, completeFromList as W } from "../../autocomplete/dist/index.mjs";
import { NodeWeakMap as H, IterMode as K } from "../../../@lezer/common/dist/index.mjs";
const I = [
...
]), h = /* @__PURE__ */ new H(), J = /* @__PURE__ */ new Set([
  "Script",
  "Block",
  "FunctionExpression",
  "FunctionDeclaration",
...
const p = /* @__PURE__ */ j.define({
  ...
  facet: /* @__PURE__ */ x({ commentTokens: { block: { open: "{/*", close: "*/}" } } })
...
const ne = typeof navigator == "object" && /* @__PURE__ */ /Android\b/.test(navigator.userAgent), ae = /* @__PURE__ */ _.inputHandler.of((e, t, o, n, l) => {
  ...
  let u = l(), { state: a } = u, s = a.changeByRange((f) => {
    var g;
    let { head: i } = f, c = C(a).resolveInner(i - 1, -1), y;
