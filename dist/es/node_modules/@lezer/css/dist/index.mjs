import { LRParser as z, ExternalTokenizer as c, LocalTokenGroup as Y } from "../../lr/dist/index.mjs";
import { styleTags as g, tags as Q } from "../../highlight/dist/index.mjs";
const h = 122, $ = 1, k = 123, u = 124, P = 2, j = 125, G = 3, f = 4, X = [
  ...
  8287,
  12288
], R = 58, q = 40, m = 95, E = 91, S = 45, T = 46, b = 35, x = 37, U = 38, _ = 92, V = 10, v = 42;
function l(O) {
...
const n = (O, e, p) => (a, y) => {
  for (let t = !1, o = 0, d = 0; ; d++) {
    ...
    if (l(r) || r == S || r == m || t && i(r))
      !t && (r != S || d > 0) && (t = !0), o === d && r == S && o++, a.advance();
    else if (r == _ && a.peek(1) != V) {
      if (a.advance(), s(a.next)) {
        do
          a.advance();
        while (s(a.next));
        a.next == 32 && a.advance();
  ...
  if (X.includes(O.peek(-1))) {
    let { next: e } = O;
    (l(e) || e == m || e == b || e == T || e == v || e == E || e == R && l(O.peek(1)) || e == S || e == U) && O.acceptToken(h);
  }
}), w = new c((O) => {
  if (!X.includes(O.peek(-1))) {
    let { next: e } = O;
    if (e == x && (O.advance(), O.acceptToken($)), l(e)) {
      do
        O.advance();
  ...
  "[ ]": Q.squareBracket,
  "{ }": Q.brace
}), I = { __proto__: null, lang: 38, "nth-child": 38, "nth-last-child": 38, "nth-of-type": 38, "nth-last-of-type": 38, dir: 38, "host-context": 38, if: 84, url: 124, "url-prefix": 124, domain: 124, regexp: 124 }, F = { __proto__: null, or: 98, and: 98, not: 106, only: 106, layer: 170 }, D = { __proto__: null, selector: 112, layer: 166 }, B = { __proto__: null, "@import": 162, "@media": 174, "@charset": 178, "@namespace": 182, "@keyframes": 188, "@supports": 200, "@scope": 204 }, K = { __proto__: null, to: 207 }, L = z.deserialize({
  version: 14,
  ...
  tokenizers: [C, w, W, Z, 1, 2, 3, 4, new Y("m~RRYZ[z{a~~g~aO#v~~dP!P!Qg~lO#w~~", 28, 129)],
  topRules: { StyleSheet: [0, 6], Styles: [1, 105] },
  specialized: [{ term: 124, get: (O) => I[O] || -1 }, { term: 125, get: (O) => F[O] || -1 }, { term: 4, get: (O) => D[O] || -1 }, { term: 25, get: (O) => B[O] || -1 }, { term: 123, get: (O) => K[O] || -1 }],
  tokenPrec: 1963
});
export {
  L as parser
